...
(function($) {
  ...
  $(function() {
    $(document).on("click", "a.page-scroll", function(event) {
      ...
      $("html, body")
        ...
        .animate(
          {
            scrollTop: $($anchor.attr("href")).offset().top // 返回当前点击的元素的 - href属性的offset的Top距离
          },
          600,
          "easeInOutExpo"
        );
  ...
  function init() {
    ...
    $("#sidebar-menu a").on("click", function(e) {
      ...
      // 查找<a>标签是否有子标签，因为子标签格式是 a -> ul -> li -> a, 所以 如果有就给<a>加上 class subdrop
      if (!$(this).hasClass("subdrop")) {
        // 如果点击另一个子标签的<a>标签，主动会把上一个的<a>标签的父标签<ul>的subdrop去掉，并调用slideup()方法
